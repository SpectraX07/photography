...
<?= $this->section('vendorCss') ?>
	...
	<link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/libs/fullcalendar/fullcalendar.css">
...
<?= $this->section('pageCss') ?>
	<link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/css/pages/app-calendar.css">
<?= $this->endSection() ?>
<?= $this->section('vendorJs') ?>
	<script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/fullcalendar/fullcalendar.js"></script>
...
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
	<script src="<?= ADMIN_ASSETS ?>assets/js/app-calendar-events.js"></script>
	<script src="<?= ADMIN_ASSETS ?>assets/js/app-calendar.js"></script>
<?= $this->endSection() ?>
