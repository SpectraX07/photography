			...
			<div class="sidebar-header">
				<div class="d-flex align-items-center me-3 me-lg-0">
					<div class="flex-shrink-0 avatar avatar-online me-3" data-bs-toggle="sidebar" data-overlay="app-overlay-ex" data-target="#app-chat-sidebar-left">
						<img class="user-avatar rounded-circle cursor-pointer" src="<?= ADMIN_ASSETS ?>assets/img/avatars/1.png" alt="Avatar">
					</div>
			...
			<div class="sidebar-body">
					...
					<li class="chat-contact-list-item">
						<a class="d-flex align-items-center">
							<div class="flex-shrink-0 avatar avatar-online">
								<img src="<?= ADMIN_ASSETS ?>assets/img/avatars/13.png" alt="Avatar" class="rounded-circle">
							</div>
				...
				<ul class="list-unstyled chat-contact-list mb-0" id="contact-list">
					...
					<li class="chat-contact-list-item">
						<a class="d-flex align-items-center">
							<div class="flex-shrink-0 avatar avatar-busy">
								<img src="<?= ADMIN_ASSETS ?>assets/img/avatars/11.png" alt="Avatar" class="rounded-circle">
							</div>
							<div class="chat-contact-info flex-grow-1 ms-2">
					...
					<div class="d-flex justify-content-between align-items-center">
						<div class="d-flex overflow-hidden align-items-center">
							...
							<div class="flex-shrink-0 avatar">
								<img src="<?= ADMIN_ASSETS ?>assets/img/avatars/2.png" alt="Avatar" class="rounded-circle" data-bs-toggle="sidebar" data-overlay="" data-target="#app-chat-sidebar-right">
							</div>
							<div class="chat-contact-info flex-grow-1 ms-2">
...
<?= $this->section('pageCss') ?>
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/css/pages/app-chat.css">
<?= $this->endSection() ?>
<?= $this->section('vendorJs') ?>
	<script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/bootstrap-maxlength/bootstrap-maxlength.js"></script>
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
    <<script src="<?= ADMIN_ASSETS ?>assets/js/app-chat.js"></script>
<?= $this->endSection() ?>
