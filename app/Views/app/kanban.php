...
<?= $this->section('vendorCss') ?>
	...
	<link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/libs/jkanban/jkanban.css">
...
<?= $this->section('pageCss') ?>
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/css/pages/app-kanban.css">
<?= $this->endSection() ?>
<?= $this->section('vendorJs') ?>
	...
	<script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/jkanban/jkanban.js"></script>
...
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
    <script src="<?= ADMIN_ASSETS ?>assets/js/app-kanban.js"></script>
<?= $this->endSection() ?>
