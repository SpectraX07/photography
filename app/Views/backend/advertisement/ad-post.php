...
<div class="content-wrapper">
	<div class="container-xxl flex-grow-1 container-p-y">
		<h4 class="fw-bold py-3 mb-4">
			<span class="text-muted fw-light">AD Post /</span> List
		</h4>
		<div class="card p-4">
			<div class="table-responsive text-nowrap">
				<table class='table' id="ajaxDtADPost">
					<?= csrf_field(); ?>
					<thead>
						<tr>
							<th>#</th>
		...
		<div class="modal-content p-3 p-md-5">
			<div class="modal-body">
				...
				<div class="text-center mb-4">
					<h3 class="edit-title mb-2">Edit AD Post</h3>
				</div>
				<?= form_open(route_to('update-ad'), ['id' => 'editADForm', 'class' => 'row g-3']); ?>
				<div class="col-12">
...
<div class="modal fade" id="addNewADModal" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-simple modal-add-new-edit">
		<div class="modal-content p-3 p-md-5">
			<div class="modal-body">
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				<div class="text-center mb-2">
					<h3 class="edit-title mb-2">Post AD</h3>
				</div>
				<?= form_open(route_to('post-new-ad'), ['id' => 'addADForm', 'class' => 'row g-3']); ?>
				<div class="col-12">
					<label class="form-label">Title</label>
					<input type="text" name="title" class="form-control" placeholder="Enter title">
					<div class="invalid-feedback"></div>
...
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
<script src="<?= ADMIN_ASSETS ?>assets/js/page/advertisement.js?v=<?= filemtime('assets/js/page/advertisement.js') ?>"></script>
<?= $this->endSection() ?>
