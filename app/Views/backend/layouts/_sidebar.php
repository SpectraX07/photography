<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="<?= url_to('superAdmin') ?>" class="menu-link">
       ...
       <!--  <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="<?= site_url('app/user-view-account') ?>" class="menu-link">
                <div data-i18n="Account">Account</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?= site_url('app/user-view-security') ?>" class="menu-link">
                <div data-i18n="Security">Security</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?= site_url('app/user-view-billing') ?>" class="menu-link">
                <div data-i18n="Billing & Plans">Billing & Plans</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?= site_url('app/user-view-notifications') ?>" class="menu-link">
                <div data-i18n="Notifications">Notifications</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?= site_url('app/user-view-connections') ?>" class="menu-link">
   ...
   <!--  <li class="menu-item">
      <a href="<?= url_to('ad-post') ?>" class="menu-link">
      <i class="menu-icon tf-icons ti ti-ad"></i>
        <div data-i18n="AD Post">AD Post</div>
      </a>
    </li>

    <li class="menu-item">
      <a href="<?= url_to('radio') ?>" class="menu-link">
      <i class="menu-icon tf-icons ti ti-radio"></i>
