				...
				<ul class="p-0 m-0">
					<li class="mb-4 d-flex">
						<div class="d-flex w-50 align-items-center me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/laravel-logo.png" alt="laravel-logo" class="me-3" width="35">
							<div>
					...
					<li class="mb-4 d-flex">
						<div class="d-flex w-50 align-items-center me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/figma-logo.png" alt="figma-logo" class="me-3" width="35">
							<div>
					...
					<li class="mb-4 d-flex">
						<div class="d-flex w-50 align-items-center me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/vue-logo.png" alt="vue-logo" class="me-3" width="35">
							<div>
					...
					<li class="mb-4 d-flex">
						<div class="d-flex w-50 align-items-center me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/react-logo.png" alt="react-logo" class="me-3" width="35">
							<div>
					...
					<li class="mb-4 d-flex">
						<div class="d-flex w-50 align-items-center me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/bootstrap-logo.png" alt="bootstrap-logo" class="me-3" width="35">
							<div>
					...
					<li class="d-flex">
						<div class="d-flex w-50 align-items-center me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/sketch-logo.png" alt="sketch-logo" class="me-3" width="35">
							<div>
			...
			<div class="card-body">
				<ul class="p-0 m-0">
					<li class="d-flex align-items-center mb-4">
						<img src="<?= ADMIN_ASSETS ?>assets/svg/flags/us.svg" alt="User" class="rounded-circle me-3" width="34">
					...
					<li class="d-flex align-items-center mb-4">
						<img src="<?= ADMIN_ASSETS ?>assets/svg/flags/br.svg" alt="User" class="rounded-circle me-3" width="34">
						<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
							<div class="me-2">
								<div class="d-flex align-items-center">
					...
					<li class="d-flex align-items-center mb-4">
						<img src="<?= ADMIN_ASSETS ?>assets/svg/flags/in.svg" alt="User" class="rounded-circle me-3" width="34">
						<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
							<div class="me-2">
								<div class="d-flex align-items-center">
					...
					<li class="d-flex align-items-center mb-4">
						<img src="<?= ADMIN_ASSETS ?>assets/svg/flags/au.svg" alt="User" class="rounded-circle me-3" width="34">
						<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
							<div class="me-2">
								<div class="d-flex align-items-center">
					...
					<li class="d-flex align-items-center mb-4">
						<img src="<?= ADMIN_ASSETS ?>assets/svg/flags/fr.svg" alt="User" class="rounded-circle me-3" width="34">
						<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
							<div class="me-2">
								<div class="d-flex align-items-center">
					...
					<li class="d-flex align-items-center">
						<img src="<?= ADMIN_ASSETS ?>assets/svg/flags/cn.svg" alt="User" class="rounded-circle me-3" width="34">
						<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
							<div class="me-2">
								<div class="d-flex align-items-center">
			...
			<div class="card-body">
				<ul class="p-0 m-0">
					<li class="d-flex mb-4 pb-1 align-items-center">
						<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/chrome.png" alt="Chrome" height="28" class="me-3 rounded">
					...
					<li class="d-flex mb-4 pb-1 align-items-center">
						<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/safari.png" alt="Safari" height="28" class="me-3 rounded">
						<div class="d-flex w-100 align-items-center gap-2">
							<div class="d-flex justify-content-between flex-grow-1 flex-wrap">
								<div>
					...
					<li class="d-flex mb-4 pb-1 align-items-center">
						<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/firefox.png" alt="Firefox" height="28" class="me-3 rounded">
						<div class="d-flex w-100 align-items-center gap-2">
							<div class="d-flex justify-content-between flex-grow-1 flex-wrap">
								<div>
					...
					<li class="d-flex mb-4 pb-1 align-items-center">
						<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/opera.png" alt="Opera" height="28" class="me-3 rounded">
						<div class="d-flex w-100 align-items-center gap-2">
							<div class="d-flex justify-content-between flex-grow-1 flex-wrap">
								<div>
					...
					<li class="d-flex mb-4 pb-1 align-items-center">
						<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/edge.png" alt="Edge" height="28" class="me-3 rounded">
						<div class="d-flex w-100 align-items-center gap-2">
							<div class="d-flex justify-content-between flex-grow-1 flex-wrap">
								<div>
					...
					<li class="d-flex align-items-center">
						<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/brave.png" alt="Brave" height="28" class="me-3 rounded">
						<div class="d-flex w-100 align-items-center gap-2">
							<div class="d-flex justify-content-between flex-grow-1 flex-wrap">
								<div>
			...
			<div class="card-body">
				<ul class="p-0 m-0">
					<li class="d-flex mb-4 pb-1">
						<div class="me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/products/iphone.png" alt="User" class="rounded" width="46">
						</div>
						<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
							<div class="me-2">
					...
					<li class="d-flex mb-4 pb-1">
						<div class="me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/products/nike-air-jordan.png" alt="User" class="rounded" width="46">
						</div>
						<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
							<div class="me-2">
					...
					<li class="d-flex mb-4 pb-1">
						<div class="me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/products/headphones.png" alt="User" class="rounded" width="46">
						</div>
						<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
							<div class="me-2">
					...
					<li class="d-flex mb-4 pb-1">
						<div class="me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/products/apple-watch.png" alt="User" class="rounded" width="46">
						</div>
						<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
							<div class="me-2">
					...
					<li class="d-flex mb-4 pb-1">
						<div class="me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/products/amazon-echo.png" alt="User" class="rounded" width="46">
						</div>
						<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
							<div class="me-2">
					...
					<li class="d-flex">
						<div class="me-3">
							<img src="<?= ADMIN_ASSETS ?>assets/img/products/play-station.png" alt="User" class="rounded" width="46">
						</div>
						<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
							<div class="me-2">
					...
					<tbody>
						<tr>
							<td>
								<div class="d-flex justify-content-start align-items-center">
									<div class="me-3">
										<img src="<?= ADMIN_ASSETS ?>assets/img/icons/payments/visa-img.png" alt="Visa" height="30">
									</div>
						...
						<tr>
							<td>
								<div class="d-flex justify-content-start align-items-center">
									<div class="me-3">
										<img src="<?= ADMIN_ASSETS ?>assets/img/icons/payments/master-card-img.png" alt="Visa" height="30">
									</div>
									<div class="d-flex flex-column">
						...
						<tr>
							<td>
								<div class="d-flex justify-content-start align-items-center">
									<div class="me-3">
										<img src="<?= ADMIN_ASSETS ?>assets/img/icons/payments/american-express-img.png" alt="Visa" height="30">
									</div>
									<div class="d-flex flex-column">
				...
				<ul class="timeline ms-1 mb-0">
					...
					<li class="timeline-item timeline-item-transparent ps-4">
						...
						<div class="timeline-event">
							...
							<p class="mb-2">Sent by Mollie Dixon <img src="<?= ADMIN_ASSETS ?>assets/img/avatars/4.png" class="rounded-circle me-3" alt="avatar" height="24" width="24"></p>
							<div class="d-flex flex-wrap gap-2 pt-1">
								<a href="javascript:void(0)" class="me-3">
									<img src="<?= ADMIN_ASSETS ?>assets/img/icons/misc/doc.png" alt="Document image" width="15" class="me-2">
									<span class="fw-semibold text-heading">App Guidelines</span>
								</a>
								<a href="javascript:void(0)">
									<img src="<?= ADMIN_ASSETS ?>assets/img/icons/misc/xls.png" alt="Excel image" width="15" class="me-2">
			...
			<div class="swiper-wrapper">
					...
					<div class="row">
						...
						<div class="row">
							...
							<div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
								<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/card-website-analytics-1.png" alt="Website Analytics" width="170" class="card-website-analytics-img">
							</div>
						</div>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="row">
						...
						<div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
							<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/card-website-analytics-2.png" alt="Website Analytics" width="170" class="card-website-analytics-img">
						</div>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="row">
						...
						<div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
							<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/card-website-analytics-3.png" alt="Website Analytics" width="170" class="card-website-analytics-img">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="d-flex align-items-end row">
				...
				<div class="col-5 text-center text-sm-left">
					<div class="card-body pb-0 px-0 px-md-4">
						<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/card-advance-sale.png" height="140" alt="view sales">
					</div>
				</div>
			</div>
		</div>
...
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
	<script src="<?= ADMIN_ASSETS ?>assets/js/cards-advance.js"></script>
<?= $this->endSection() ?>
