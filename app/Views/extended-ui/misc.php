...
<?= $this->section('vendorJs') ?>
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/clipboard/clipboard.js"></script>
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/moment/moment.js"></script>
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/idletimer/idletimer.js"></script>
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/numeral/numeral.js"></script>
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/toastr/toastr.js"></script>
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
  <script src="<?= ADMIN_ASSETS ?>assets/js/extended-ui-misc-clipboardjs.js"></script>
  <script src="<?= ADMIN_ASSETS ?>assets/js/extended-ui-misc-idle-timer.js"></script>
  <script src="<?= ADMIN_ASSETS ?>assets/js/extended-ui-misc-numeraljs.js"></script>
<?= $this->endSection() ?>
