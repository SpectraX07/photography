          ...
          <div class="timeline-event card p-0" data-aos="fade-left">
            ...
            <div class="card-body">
              <div class="d-flex flex-sm-row flex-column">
                <img src="<?= ADMIN_ASSETS ?>assets/img/elements/10.jpg" class="rounded me-3 mb-sm-0 mb-2" alt="doughnut" height="64" width="64">
                <div>
                  <h6 class="mb-2">
...
<?= $this->section('vendorCss') ?>
  ...
  <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/libs/animate-on-scroll/animate-on-scroll.css">
<?= $this->endSection() ?>
<?= $this->section('vendorJs') ?>
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/animate-on-scroll/animate-on-scroll.js"></script>
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
  <script src="<?= ADMIN_ASSETS ?>assets/js/extended-ui-timeline.js"></script>
<?= $this->endSection() ?>
