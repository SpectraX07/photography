...
<?= $this->section('vendorCss') ?>
  ...
  <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/libs/bootstrap-datepicker/bootstrap-datepicker.css">
  <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.css">
  <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/libs/jquery-timepicker/jquery-timepicker.css">
  <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/libs/pickr/pickr-themes.css">
<?= $this->endSection() ?>
<?= $this->section('vendorJs') ?>
  ...
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/bootstrap-datepicker/bootstrap-datepicker.js"></script>
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.js"></script>
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/jquery-timepicker/jquery-timepicker.js"></script>
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/pickr/pickr.js"></script>
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
 <script src="<?= ADMIN_ASSETS ?>assets/js/forms-pickers.js"></script>
<?= $this->endSection() ?>
