...
<?= $this->section('vendorJs') ?>
  ...
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/bloodhound/bloodhound.js"></script>
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
 <script src="<?= ADMIN_ASSETS ?>assets/js/forms-selects.js"></script>
 <script src="<?= ADMIN_ASSETS ?>assets/js/forms-tagify.js"></script>
 <script src="<?= ADMIN_ASSETS ?>assets/js/forms-typeahead.js"></script>
<?= $this->endSection() ?>
