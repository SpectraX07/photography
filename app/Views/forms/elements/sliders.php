...
<?= $this->section('vendorCss') ?>
  ...
  <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/libs/nouislider/nouislider.css">
<?= $this->endSection() ?>
<?= $this->section('vendorJs') ?>
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/nouislider/nouislider.js"></script>
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
  <script src="<?= ADMIN_ASSETS ?>assets/js/forms-sliders.js"></script>
<?= $this->endSection() ?>
