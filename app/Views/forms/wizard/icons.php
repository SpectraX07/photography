      ...
      <div class="bs-stepper-header">
          ...
          <button type="button" class="step-trigger">
            <span class="bs-stepper-icon">
              <svg viewbox="0 0 54 54">
                <use xlink:href='<?= ADMIN_ASSETS ?>assets/svg/icons/form-wizard-account.svg#wizardAccount'></use>
              </svg>
            </span>
          ...
          <button type="button" class="step-trigger">
            <span class="bs-stepper-icon">
              <svg viewbox="0 0 58 54">
                <use xlink:href='<?= ADMIN_ASSETS ?>assets/svg/icons/form-wizard-personal.svg#wizardPersonal'></use>
              </svg>
            </span>
        ...
        <div class="step" data-target="#address">
          <button type="button" class="step-trigger">
            <span class="bs-stepper-icon">
              <svg viewbox="0 0 54 54">
                <use xlink:href='<?= ADMIN_ASSETS ?>assets/svg/icons/form-wizard-address.svg#wizardAddress'></use>
              </svg>
            </span>
        ...
        <div class="step" data-target="#social-links">
          <button type="button" class="step-trigger">
            <span class="bs-stepper-icon">
              <svg viewbox="0 0 54 54">
                <use xlink:href='<?= ADMIN_ASSETS ?>assets/svg/icons/form-wizard-social-link.svg#wizardSocialLink'></use>
              </svg>
            </span>
        ...
        <div class="step" data-target="#review-submit">
          <button type="button" class="step-trigger">
            <span class="bs-stepper-icon">
              <svg viewbox="0 0 54 54">
                <use xlink:href='<?= ADMIN_ASSETS ?>assets/svg/icons/form-wizard-submit.svg#wizardSubmit'></use>
              </svg>
            </span>
...
<?= $this->section('vendorJs') ?>
  ...
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/bootstrap-select/bootstrap-select.js"></script>
  <script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/select2/select2.js"></script>
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
  <script src="<?= ADMIN_ASSETS ?>assets/js/form-wizard-icons.js"></script>
<?= $this->endSection() ?>
