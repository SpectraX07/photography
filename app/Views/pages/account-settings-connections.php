					...
					<div class="card-body">
						...
						<div class="d-flex mb-3">
							<div class="flex-shrink-0">
								<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/google.png" alt="google" class="me-3" height="30">
							</div>
						...
						<div class="d-flex mb-3">
							<div class="flex-shrink-0">
								<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/slack.png" alt="slack" class="me-3" height="30">
							</div>
							<div class="flex-grow-1 row">
								<div class="col-sm-9">
						...
						<div class="d-flex mb-3">
							<div class="flex-shrink-0">
								<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/github.png" alt="github" class="me-3" height="30">
							</div>
							<div class="flex-grow-1 row">
								<div class="col-sm-9">
						...
						<div class="d-flex mb-3">
							<div class="flex-shrink-0">
								<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/mailchimp.png" alt="mailchimp" class="me-3" height="30">
							</div>
							<div class="flex-grow-1 row">
								<div class="col-sm-9">
						...
						<div class="d-flex">
							<div class="flex-shrink-0">
								<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/asana.png" alt="asana" class="me-3" height="30">
							</div>
							<div class="flex-grow-1 row">
								<div class="col-sm-9">
