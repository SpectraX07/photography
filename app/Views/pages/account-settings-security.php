			...
			<div class="row">
				...
				<div class="col-md-7 order-md-1 order-0">
					<div class="text-center mt-4 mx-3 mx-md-0">
						<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/girl-with-laptop.png" class="img-fluid" alt="Api Key Image" width="202">
					</div>
				</div>
			</div>
		</div>
...
<link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/css/pages/page-account-settings.css">
<?= $this->endSection() ?>
...
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
	<script src="<?= ADMIN_ASSETS ?>assets/js/pages-account-settings-security.js"></script>
