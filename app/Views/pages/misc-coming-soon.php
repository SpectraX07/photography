...
<head>
	...
	<link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/css/pages/page-misc.css">
...
<body>
	...
	<div class="container-xxl container-p-y">
		<div class="misc-wrapper">
			...
			<div class="mt-4">
				<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/page-misc-launching-soon.png" alt="page-misc-launching-soon" width="263" class="img-fluid">
			</div>
		</div>
	</div>
	<div class="container-fluid misc-bg-wrapper">
		<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/bg-shape-image-dark.png" alt="page-misc-coming-soon" data-app-light-img="illustrations/bg-shape-image-light.png" data-app-dark-img="illustrations/bg-shape-image-dark.png">
	</div>
