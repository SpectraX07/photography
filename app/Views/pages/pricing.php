			...
			<div class="position-relative">
				<div class="d-flex justify-content-between flex-column-reverse flex-lg-row align-items-center py-4 px-5">
					<div class="text-center text-lg-start mt-2 ms-3">
						...
						<a href="auth-register-basic.html" class="btn btn-primary mt-4 mb-2">Start 14-day FREE trial</a>
					</div>
					<div class="text-center">
						<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/girl-with-laptop.png" class="img-fluid me-lg-5 pe-lg-1 mb-3 mb-lg-0" alt="Api Key Image" width="202">
					</div>
				</div>
			</div>
		</div>
						...
						<table class="table table-striped text-center mb-0">
							...
							<tbody>
								...
								<tr>
									<td></td>
									<td>
										<a href="auth-register-basic.html" class="btn text-nowrap btn-label-primary">Choose Plan</a>
									</td>
									<td>
...
<link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/css/pages/page-pricing.css">
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
