			...
			<div class="card">
				<div class="card-body">
					<div class="d-flex align-items-center mb-3">
						<a href="javascript:;" class="d-flex align-items-center">
							<div class="avatar me-2">
								<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/xd-label.png" alt="Avatar" class="rounded-circle">
							</div>
							<div class="me-2 text-body h5 mb-0">
								Creative Designers
							</div>
			...
			<div class="card">
				<div class="card-body">
					<div class="d-flex align-items-center mb-3">
						<a href="javascript:;" class="d-flex align-items-center">
							<div class="avatar me-2">
								<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/social-label.png" alt="Avatar" class="rounded-circle">
							</div>
							<div class="me-2 text-body h5 mb-0">
								Digital Marketing
							</div>
			...
			<div class="card">
				<div class="card-body">
					<div class="d-flex align-items-center mb-3">
						<a href="javascript:;" class="d-flex align-items-center">
							<div class="avatar me-2">
								<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/event-label.png" alt="Avatar" class="rounded-circle">
							</div>
							<div class="me-2 text-body h5 mb-0">
								Event
							</div>
			...
			<div class="card">
				<div class="card-body">
					<div class="d-flex align-items-center mb-3">
						<a href="javascript:;" class="d-flex align-items-center">
							<div class="avatar me-2">
								<img src="<?= ADMIN_ASSETS ?>assets/img/icons/brands/html-label.png" alt="Avatar" class="rounded-circle">
							</div>
							<div class="me-2 text-body h5 mb-0">
								Only Beginners
							</div>
