...
<section id="basic-footer">
	...
	<footer class="footer bg-light">
		<div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
			<div>
				<a href="https://demos.pixinvent.com/vuexy-html-admin-template/landing-page/" target="_blank" class="footer-text fw-bolder">Vuexy</a> ©
			</div>
			<div>
		...
		<div class="container-fluid container-p-x pt-5 pb-4">
			<div class="row">
				<div class="col-12 col-sm-6 col-md-3 mb-4 mb-sm-0">
					<h4 class="fw-bolder mb-3"><a href="https://demos.pixinvent.com/vuexy-html-admin-template/landing-page/" target="_blank" class="footer-text">Vuexy </a></h4>
