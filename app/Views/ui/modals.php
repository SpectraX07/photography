								...
								<div class="carousel-inner">
									<div class="carousel-item active">
										<div class="onboarding-media">
											<div class="mx-2">
												<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/girl-with-laptop-dark.png" alt="girl-with-laptop-light" width="335" class="img-fluid" data-app-light-img="illustrations/girl-with-laptop-light.png" data-app-dark-img="illustrations/girl-with-laptop-dark.png">
											</div>
										</div>
									...
									<div class="carousel-item">
										<div class="onboarding-media">
											<div class="mx-2">
												<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/boy-with-laptop-dark.png" alt="boy-with-laptop-light" width="300" class="img-fluid" data-app-light-img="illustrations/boy-with-laptop-light.png" data-app-dark-img="illustrations/boy-with-laptop-dark.png">
											</div>
										</div>
										<div class="onboarding-content">
											<h4 class="onboarding-title text-body">Example Request Information</h4>
									...
									<div class="carousel-item">
										<div class="onboarding-media">
											<div class="mx-2">
												<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/girl-verify-password-dark.png" alt="girl-verify-password-light" width="300" class="img-fluid" data-app-light-img="illustrations/girl-verify-password-light.png" data-app-dark-img="illustrations/girl-verify-password-dark.png">
											</div>
										</div>
										<div class="onboarding-content">
											<h4 class="onboarding-title text-body">Example Request Information</h4>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content text-center">
							...
							<div class="modal-body p-0">
								<div class="onboarding-media">
									<div class="mx-2">
										<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/girl-unlock-password-dark.png" alt="girl-unlock-password-light" width="335" class="img-fluid" data-app-light-img="illustrations/girl-unlock-password-light.png" data-app-dark-img="illustrations/girl-unlock-password-dark.png">
									</div>
								</div>
								...
								<div class="carousel-inner">
									<div class="carousel-item active">
										<div class="onboarding-horizontal">
											<div class="onboarding-media">
												<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/boy-with-rocket-dark.png" alt="boy-with-rocket-light" width="273" class="img-fluid" data-app-light-img="illustrations/boy-with-rocket-light.png" data-app-dark-img="illustrations/boy-with-rocket-dark.png">
											</div>
											<div class="onboarding-content">
												<h4 class="onboarding-title text-body">Example Request Information</h4>
												<div class="onboarding-info">In this example you can see a form where you can request some
									...
									<div class="carousel-item">
										<div class="onboarding-horizontal">
											<div class="onboarding-media">
												<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/girl-doing-yoga-dark.png" alt="boy-with-rocket-light" width="273" class="img-fluid" data-app-light-img="illustrations/girl-doing-yoga-light.png" data-app-dark-img="illustrations/girl-doing-yoga-dark.png">
											</div>
											<div class="onboarding-content">
												<h4 class="onboarding-title text-body">Example Request Information</h4>
												<div class="onboarding-info">In this example you can see a form where you can request some
									...
									<div class="carousel-item">
										<div class="onboarding-horizontal">
											<div class="onboarding-media">
												<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/boy-with-laptop-dark.png" alt="boy-with-laptop-light" width="273" class="img-fluid" data-app-light-img="illustrations/boy-with-laptop-light.png" data-app-dark-img="illustrations/boy-with-laptop-dark.png">
											</div>
											<div class="onboarding-content">
												<h4 class="onboarding-title text-body">Example Request Information</h4>
												<div class="onboarding-info">In this example you can see a form where you can request some
					...
					<div class="modal-dialog modal-xl" role="document">
						<div class="modal-content text-center">
							...
							<div class="modal-body onboarding-horizontal p-0">
								<div class="onboarding-media">
									<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/boy-verify-email-dark.png" alt="boy-verify-email-light" width="273" class="img-fluid" data-app-light-img="illustrations/boy-verify-email-light.png" data-app-dark-img="illustrations/boy-verify-email-dark.png">
								</div>
								<div class="onboarding-content mb-0">
									<h4 class="onboarding-title text-body">Example Request Information</h4>
									<div class="onboarding-info">In this example you can see a form where you can request some additional
