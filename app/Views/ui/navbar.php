...
<?= $this->section('vendorJs') ?>
	<script src="<?= ADMIN_ASSETS ?>assets/vendor/js/dropdown-hover.js"></script>
	<script src="<?= ADMIN_ASSETS ?>assets/vendor/js/mega-dropdown.js"></script>
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
	<script src="<?= ADMIN_ASSETS ?>assets/js/ui-navbar.js"></script>
<?= $this->endSection() ?>