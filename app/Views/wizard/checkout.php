	...
	<div class="bs-stepper-header m-auto border-0 py-5">
			...
			<button type="button" class="step-trigger">
				<span class="bs-stepper-icon">
					<svg viewbox="0 0 58 54">
						<use xlink:href='<?= ADMIN_ASSETS ?>assets/svg/icons/wizard-checkout-cart.svg#wizardCart'></use>
					</svg>
				</span>
			...
			<button type="button" class="step-trigger">
				<span class="bs-stepper-icon">
					<svg viewbox="0 0 54 54">
						<use xlink:href='<?= ADMIN_ASSETS ?>assets/svg/icons/wizard-checkout-address.svg#wizardCheckoutAddress'></use>
					</svg>
				</span>
		...
		<div class="step" data-target="#checkout-payment">
			<button type="button" class="step-trigger">
				<span class="bs-stepper-icon">
					<svg viewbox="0 0 58 54">
						<use xlink:href='<?= ADMIN_ASSETS ?>assets/svg/icons/wizard-checkout-payment.svg#wizardPayment'></use>
					</svg>
				</span>
		...
		<div class="step" data-target="#checkout-confirmation">
			<button type="button" class="step-trigger">
				<span class="bs-stepper-icon">
					<svg viewbox="0 0 58 54">
						<use xlink:href='<?= ADMIN_ASSETS ?>assets/svg/icons/wizard-checkout-confirmation.svg#wizardConfirm'></use>
					</svg>
				</span>
					...
					<div class="col-xl-8 mb-3 mb-xl-0">
						...
						<ul class="list-group mb-3">
							<li class="list-group-item p-4">
								<div class="d-flex gap-3">
									<div class="flex-shrink-0 d-flex align-items-center">
										<img src="<?= ADMIN_ASSETS ?>assets/img/products/1.png" alt="google home" class="w-px-100">
									</div>
									<div class="flex-grow-1">
										<div class="row">
											<div class="col-md-8">
							...
							<li class="list-group-item p-4">
								<div class="d-flex gap-3">
									<div class="flex-shrink-0 d-flex align-items-center">
										<img src="<?= ADMIN_ASSETS ?>assets/img/products/2.png" alt="google home" class="w-px-100">
									</div>
									<div class="flex-grow-1">
										<div class="row">
											<div class="col-md-8">
						...
						<div class="border rounded p-4 pb-3 mb-3">
							...
							<ul class="list-unstyled">
								<li class="d-flex gap-3 align-items-center">
									<div class="flex-shrink-0">
										<img src="<?= ADMIN_ASSETS ?>assets/img/products/1.png" alt="google home" class="w-px-50">
									</div>
									<div class="flex-grow-1">
								...
								<li class="d-flex gap-3 align-items-center">
									<div class="flex-shrink-0">
										<img src="<?= ADMIN_ASSETS ?>assets/img/products/2.png" alt="google home" class="w-px-50">
									</div>
									<div class="flex-grow-1">
					...
					<div class="col-xl-9 mb-3 mb-xl-0">
						<ul class="list-group">
							<li class="list-group-item p-4">
								<div class="d-flex gap-3">
									<div class="flex-shrink-0">
										<img src="<?= ADMIN_ASSETS ?>assets/img/products/1.png" alt="google home" class="w-px-75">
									</div>
									<div class="flex-grow-1">
										<div class="row">
											<div class="col-md-8">
							...
							<li class="list-group-item p-4">
								<div class="d-flex gap-3">
									<div class="flex-shrink-0">
										<img src="<?= ADMIN_ASSETS ?>assets/img/products/2.png" alt="google home" class="w-px-75">
									</div>
									<div class="flex-grow-1">
										<div class="row">
											<div class="col-md-8">
...
<?= $this->section('pageCss') ?>
	<link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/css/pages/wizard-ex-checkout.css">
<?= $this->endSection() ?>
...
<?= $this->section('pageJs') ?>
	...
	<script src="<?= ADMIN_ASSETS ?>assets/js/wizard-ex-checkout.js"></script>
<?= $this->endSection() ?>
