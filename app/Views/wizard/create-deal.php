			...
			<div id="deal-type" class="content">
				<div class="row g-3">
					<div class="col-12 d-flex justify-content-center border rounded pt-4">
						<img src="<?= ADMIN_ASSETS ?>assets/img/illustrations/wizard-create-deal-girl-with-laptop-dark.png" alt="wizard-create-deal" data-app-light-img="illustrations/wizard-create-deal-girl-with-laptop-light.png" data-app-dark-img="illustrations/wizard-create-deal-girl-with-laptop-dark.png" width="650" class="img-fluid">
					</div>
			...
			<div id="review-complete" class="content">
				<div class="row g-3">
					...
					<div class="col-xl-6 col-lg-5 d-flex justify-content-center border rounded pt-3">
						<img class="img-fluid" src="<?= ADMIN_ASSETS ?>assets/img/illustrations/wizard-create-deal-confirm.png" alt="deal image cap">
					</div>
					<div class="col-md-12">
						<label class="switch">
...
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
	<script src="<?= ADMIN_ASSETS ?>assets/js/wizard-ex-create-deal.js"></script>
<?= $this->endSection() ?>
