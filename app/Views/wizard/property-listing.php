									...
									<label class="form-check-label custom-option-content" for="customRadioRent">
										<span class="custom-option-body">
											<svg width="41" height="40" viewbox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
												...
												<path d="M28.375 24.375C29.4105 24.375 30.25 23.5355 30.25 22.5C30.25 21.4645 29.4105 20.625 28.375 20.625C27.3395 20.625 26.5 21.4645 26.5 22.5C26.5 23.5355 27.3395 24.375 28.375 24.375Z" fill="currentColor"></path>
											</svg>
...
<?= $this->section('vendorCss') ?>
    ...
    <link rel="stylesheet" href="<?= ADMIN_ASSETS ?>assets/vendor/libs/tagify/tagify.css">
...
<?= $this->section('vendorJs') ?>
	...
	<script src="<?= ADMIN_ASSETS ?>assets/vendor/libs/tagify/tagify.js"></script>
...
<?= $this->endSection() ?>
<?= $this->section('pageJs') ?>
	<script src="<?= ADMIN_ASSETS ?>assets/js/wizard-ex-property-listing.js"></script>
<?= $this->endSection() ?>
